...
mod suite {
    ...
    fn can_get_a_service_dc() {
        ...
        let mut test_case: RedlightService = RedlightService {
    ...
    fn test_rsl_list_sorted_by_dc() {
        ...
        let mut first: RedlightService = RedlightService {
            service: RSLCode::None,
            dc: 0,
        };
        ...
        let mut second: RedlightService = RedlightService {
            service: RSLCode::None,
            dc: 0,
        };
        ...
        let mut third: RedlightService = RedlightService {
            service: RSLCode::None,
            dc: 0,
        };
